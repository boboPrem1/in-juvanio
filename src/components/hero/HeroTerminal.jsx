...
// Migré Phase 4 — useParallax sur hero-grid et hero-photo-frame
// Le parallaxe inline de App.jsx est supprimé — il est désormais géré ici.
    ...
    <section className="hero" id="about">
      ...
      <div className="hero-left">
        <div className="hero-tag">
          <DecryptedText text={t.tag} duration={d.short ?? 400} />
        </div>
        ...
        <p className="hero-title">
          <DecryptedText text={t.title}       duration={d.long ?? 1200} /><br />
          <span>{t.positioning}</span><br />
          <DecryptedText text={t.founder}     duration={d.short ?? 400} />{' '}
          <span>Tenxyte</span>{' — '}
          <DecryptedText text={t.framework}   duration={d.medium ?? 800} /><br /><br />
          <DecryptedText text={t.desc}        duration={d.long ?? 1200} />{' '}
          <span className="hero-leadership">
            <DecryptedText text={t.leadership} duration={d.medium ?? 800} />
          </span>.
        </p>

        <div className="hero-cta">
          <a href={`mailto:${meta.contact.email}`} className="btn btn-primary">
            <DecryptedText text={t.contactBtn} duration={d.short ?? 400} />
          </a>
          <a
          ...
          >
            <DecryptedText text={t.cvBtn} duration={d.short ?? 400} />
          </a>
          <a href="#experience" className="btn btn-ghost">
            <DecryptedText text={t.expBtn} duration={d.short ?? 400} />
          </a>
        </div>
      </div>
      ...
      <a href="#tenxyte" className="hero-scroll">
        <DecryptedText text={t.scroll} duration={d.short ?? 400} />
      </a>
    </section>
  );
}
