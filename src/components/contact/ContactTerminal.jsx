// src/components/contact/ContactTerminal.jsx
// Renommé depuis components/Contact.jsx — imports ajustés
import '../Contact.css';
import DecryptedText from '../shared/DecryptedText';

export default function ContactTerminal({ language, data, skin }) {
